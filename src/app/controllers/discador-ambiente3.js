...
router.get('/', async(req, res) => {
	try{
		...
		(async () => {
			...
			console.log('Acessando amb 3');

			const urlBrow = 'http://192.168.200.247';
			...
			await page.type('#inputEmail', process.env.DISCADOR_AMBIENTE3_USERNAME);  
			await page.type('#password', process.env.DISCADOR_AMBIENTE3_PASSWORD);
...
module.exports = app => app.use('/discador-ambiente3', router);