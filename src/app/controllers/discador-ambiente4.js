...
router.get('/', async(req, res) => {
	try{
		...
		(async () => {
			...
			console.log('Acessando amb 4');

			const urlBrow = 'http://192.168.200.87';
			...
			await page.type('#inputEmail', process.env.DISCADOR_AMBIENTE4_USERNAME);  
			await page.type('#password', process.env.DISCADOR_AMBIENTE4_PASSWORD);
...
module.exports = app => app.use('/discador-ambiente4', router);